...
class TeachingAdapter(private val activity: Activity):RecyclerView.Adapter<TeachingAdapter.ClassroomViewHolder>() {
    ...
    var listClassroom = ArrayList<Classroom>()
        set(listClassroom) {
            ...
            for(i in listClassroom){
                if(i.userEmail==user?.email.toString()){
                    this.listClassroom.add(i)
                }
            }
        ...
        fun bind(classroom: Classroom) {
            ...
            binding.cvItemClassroom.setOnClickListener(CustomOnItemClickListener(adapterPosition, object : CustomOnItemClickListener.OnItemClickCallback {
                override fun onItemClicked(view: View, position: Int) {
                    ...
                    activity.startActivityForResult(intent, DetailClassroomActivity.REQUEST_UPDATE)
                }
            }))
        }
    }
