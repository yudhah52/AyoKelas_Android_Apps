...
import com.yhezra.ayokelas.adapter.EnrolledAdapter
...
class EnrolledFragment : Fragment() {
    ...
    private lateinit var binding: FragmentEnrolledBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEnrolledBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = EnrolledAdapter(requireActivity())
